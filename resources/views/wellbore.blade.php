                                            ...
                                            <div style="overflow-x:auto;">
                                                <table class="table table-hover table-responsive-md table-bordered wellbore high_priority_wellbore_table"
                                                    ...
                                                    <tr>
                                                        ...
                                                        <th class="text-center" style="width:100px;!important">Contact</th>
                                                        <th class="text-center">Follow-Up</th>
                                                        <th class="text-center" style="width:225px;!important">Owner</th>
...
{{--                                                                       id="interest_area_{{$highPriorityProspect->interest_area}}"/>--}}
                                                                ...
                                                                <td class="text-center">
                                                                    ...
                                                                    @else
                                                                        ...
                                                                        <br>{{$highPriorityProspect->owner_city}}, {{$highPriorityProspect->owner_zip}}
                                                                    @endif
