                                ...
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div id="price_container" style="padding-bottom:5px;" class="offset-2 col-md-5">
                                            <div class="row">
                                                ...
                                                <div class="offset-1 col-md-5" style="width:100%; border:1px solid grey; font-size:18px; font-weight:bold;text-align:center; padding-top:0px;">
                                    ...
                                    <div id="myTab" class="interest_nav_container">
                                        <ul class="nav nav-tabs" role="tablist">
                                            ...
                                            <li class="nav-item nav-link interest_tab" id="interest_tab_la">
                                                <a href="#la_interest_area" role="tab" data-toggle="tab" class="interest_text" aria-controls="la_interest_area">LA Interest Area</a>
                                            </li>
                                            <li class="nav-item nav-link interest_tab" id="interest_tab_etx">
                                                <a href="#etx_interest_area" role="tab" data-toggle="tab" class="interest_text" aria-controls="etx_interest_area">ETX Interest Area</a>
                                            </li>
                                        </ul>
