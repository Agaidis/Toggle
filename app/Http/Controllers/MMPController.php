    ...
    public function index()
    {
        try {
            ...
            if ($userRole === 'regular') {
                ...
                $wtxPermits = DB::table('permits')->latest('submitted_at')->where('is_stored', 0)->where('assignee', Auth::user()->id)->where('is_producing', 1)->where('interest_area', 'wtx')->groupBy('lease_name', 'reported_operator')->get();
                ...
                $nonProducingWTXPermits = DB::table('permits')->latest('submitted_at')->where('is_stored', 0)->where('assignee', Auth::user()->id)->where('interest_area', 'wtx')->where('is_producing', 0)->groupBy('lease_name', 'reported_operator')->get();
                ...
                $nonProducingWTXPermits = DB::table('permits')->latest('submitted_at')->where('is_stored', 0)->where('interest_area', 'wtx')->where('is_producing', 0)->groupBy('lease_name', 'reported_operator')->get();
                ...
                $wtxPermits = DB::table('permits')->latest('submitted_at')->where('is_stored', 0)->where('interest_area', 'wtx')->where('is_producing', 1)->groupBy('abstract', 'lease_name', 'survey')->get();
