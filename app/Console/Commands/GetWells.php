...
class GetWells extends Command
{
    ...
    public function handle()
    {
        ...
        try {
//'DAWSON%20\(TX\)', 'GAINES%20\(TX\)', 'BORDEN%20\(TX\)', 'CRANE%20\(TX\)', 'ECTOR%20\(TX\)', 'STERLING%20\(TX\)', 'MITCHELL%20\(TX\)', 'JEFF%20DAVIS%20\(TX\)', 'ANDREWS%20\(TX\)',             $eagleInterestCountiesArray = array('ATASCOSA%20\(TX\)', 'BEE%20\(TX\)', 'DEWITT%20\(TX\)', 'GONZALES%20\(TX\)', 'KARNES%20\(TX\)', 'LIVE%20OAK%20\(TX\)', 'LAVACA%20\(TX\)', 'WILSON%20\(TX\)');
            $wtxInterestCountiesArray = array('HOWARD%20\(TX\)', 'MARTIN%20\(TX\)', 'MIDLAND%20\(TX\)', 'GLASSCOCK%20\(TX\)', 'REAGAN%20\(TX\)', 'UPTON%20\(TX\)', 'WARD%20\(TX\)', 'REEVES%20\(TX\)', 'CULBERSON%20\(TX\)', 'WINKLER%20\(TX\)', 'LOVING%20\(TX\)' );
